...
function _classCallCheck(instance, Constructor) {
  ...
  var Carousel = (function() {
      ...
      _createClass2(Carousel, [{
          ...
          value: function _addTouchEventListeners() {
              ...
              var move = function move(event) { // ensure swiping with one touch and not pinching
              ...
              var end = function end(event) {
                  ...
                  _this9._handleSwipe();
                  if (_this9._config.pause === 'hover') { // If it's a touch-enabled device, mouseenter/leave are fired as
          ...
          value: function _slide(direction, element) {
                  ...
                  var directionalClassName = undefined;
                  var orderClassName = undefined;
                  var eventDirectionName = undefined;
  ...
  var Modal = (function() {
      ...
      _createClass2(Modal, [{
          ...
          value: function _setScrollbar() {
              var _this22 = this;
              if (this._isBodyOverflowing) { // Note: DOMNode.style.paddingRight returns the actual value or '' if not set
                  ...
                  $(fixedContent).each(function(index, element) {
                      ...
                      $(element).data('padding-right', actualPadding).css('padding-right', parseFloat(calculatedPadding) + _this22._scrollbarWidth + 'px');
                  }); // Adjust sticky content margin
                  $(stickyContent).each(function(index, element) {
                      var actualMargin = element.style.marginRight;
                      var calculatedMargin = $(element).css('margin-right');
                      $(element).data('margin-right', actualMargin).css('margin-right', parseFloat(calculatedMargin) - _this22._scrollbarWidth + 'px');
                  }); // Adjust body padding
          ...
          key: '_resetScrollbar',
          value: function _resetScrollbar() { // Restore fixed content padding
              var fixedContent = [].slice.call(document.querySelectorAll(Selector$4.FIXED_CONTENT));
              $(fixedContent).each(function(index, element) {
  ...
  var Tooltip = (function() {
      ...
      _createClass2(Tooltip, [{
          ...
          value: function setElementContent($element, content) {
              if (typeof content === 'object' && (content.nodeType || content.jquery)) { // Content is a DOM node or a jQuery
                  if (this.config.html) {
          ...
          value: function _getOffset() {
              ...
              if (typeof this.config.offset === 'function') {
                  offset.fn = function(data) {
                      data.offsets = _extends({}, data.offsets, _this26.config.offset(data.offsets, _this26.element) || {});
                      return data;
                  };
              } else {
  ...
  var ScrollSpy = (function() {
      ...
      _createClass2(ScrollSpy, [{
          ...
          value: function _activate(target) {
              ...
              } else { // Set triggered link as active
  ...
  var BaseInput = (function($) {
      ...
      var BaseInput = /*#__PURE__*/ (function(_Base) {
          ...
          _proto.addChangeListener = function addChangeListener() {
              ...
              this.$element.on("keydown paste", function(event) {
              ...
              }).on("keyup change", function() { // make sure empty is added back when there is a programmatic value change.
                  ...
                  if (_this3.config.validate) { // Validation events do not bubble, so they must be attached directly to the text: http://jsfiddle.net/PEpRM/1/
          ...
          _proto.resolveMdbFormGroup = function resolveMdbFormGroup() {
              ...
              if (mfg === undefined || mfg.length === 0) {
                  if (this.config.bmdFormGroup.create && (this.$formGroup === undefined || this.$formGroup.length === 0)) { // If a form-group doesn't exist (not recommended), take a guess and wrap the element (assuming no label).
                  ...
                  } else { // a form-group does exist, add our marker class to it
          ...
          _proto.resolveMdbLabel = function resolveMdbLabel() {
              ...
              if (label === undefined || label.length === 0) { // we need to find it based on the configured selectors
                  label = this.findMdbLabel(this.config.label.required);
                  if (label === undefined || label.length === 0);
                  else { // a candidate label was found, add the configured default class name
          ...
          _proto.resolveMdbFormGroupSizing = function resolveMdbFormGroupSizing() {
              ...
              for (var inputSize in FormControlSizeMarkers) {
                  if (this.$element.hasClass(inputSize)) { //this.$element.removeClass(inputSize)
  ...
  var BaseSelection = (function($) {
      ...
      var BaseSelection = /*#__PURE__*/ (function(_BaseInput) {
          ...
          _proto.outerElement = function outerElement() { // .checkbox|switch|radio > label > input[type=checkbox|radio]
              // label.checkbox-inline > input[type=checkbox|radio]
              // .${this.outerClass} > label > input[type=${this.inputType}]
              return this.$element.parent().closest("." + this.outerClass);
          };
          _proto.rejectWithoutRequiredStructure = function rejectWithoutRequiredStructure() { // '.checkbox|switch|radio > label > input[type=checkbox|radio]'
              // '.${this.outerClass} > label > input[type=${this.inputType}]'
  ...
  var Checkbox = (function($) {
      ...
      var Checkbox = /*#__PURE__*/ (function(_BaseSelection) {
          ...
          Checkbox.matches = function matches($element) { // '.checkbox > label > input[type=checkbox]'
  ...
  var CollapseInline = (function($) {
      ...
      var CollapseInline = /*#__PURE__*/ (function(_Base) {
          ...
          function CollapseInline($element, config) {
              ...
              if (_this.$input) { // add a listener to set focus
  ...
  var File = (function($) {
      ...
      var File = /*#__PURE__*/ (function(_BaseInput) {
          ...
          // protected
          // Demarcation element (e.g. first child of a form-group)
          _proto.outerElement = function outerElement() { // label.file > input[type=file]
              return this.$element.parent().closest("." + ClassName.FILE);
          };
          _proto.rejectWithoutRequiredStructure = function rejectWithoutRequiredStructure() { // label.file > input[type=file]
  ...
  var Radio = (function($) {
      ...
      var Radio = /*#__PURE__*/ (function(_BaseSelection) {
          ...
          Radio.matches = function matches($element) { // '.radio > label > input[type=radio]'
      ...
      var Ripples = /*#__PURE__*/ (function() {
          ...
          _proto._onStartRipple = function _onStartRipple(event) {
              ...
              this.$element.on(this.config.trigger.end, function() {
                  if (_this2.$decorator) { // guard against race condition/mouse attack
          ...
          _proto._getRelX = function _getRelX(event) {
              ...
              var result = null;
              if (!this._isTouch()) { // Get the mouse position relative to the ripple wrapper
                  result = event.pageX - wrapperOffset.left;
              } else { // Make sure the user is using only one finger and then get the touch
  ...
  var Autofill = (function($) {
      ...
      var Autofill = /*#__PURE__*/ (function(_Base) {
          ...
          _proto._attachEventHandlers = function _attachEventHandlers() { // Listen on inputs of the focused form
  ...
  var BootstrapMaterialDesign = (function($) {
      ...
      var Default = {
          ...
          ripples: { //selector: ['.btn:not(.btn-link):not(.ripple-none)'] // testing only
          ...
          text: { // omit inputs we have specialized components to handle - we need to match text, email, etc.  The easiest way to do this appears to be just omit the ones we don't want to match and let the rest fall through to this.
              selector: ["input:not([type=hidden]):not([type=checkbox]):not([type=radio]):not([type=file]):not([type=button]):not([type=submit]):not([type=reset])"]
          },
          textarea: {
              selector: ["textarea"]
          },
          arrive: true, // create an ordered component list for instantiation
      ...
      var BootstrapMaterialDesign = /*#__PURE__*/ (function() {
          function BootstrapMaterialDesign($element, config) {
              ...
              var _loop = function _loop() {
                  ...
                  if (componentConfig) { // assemble the selector as it may be an array
                      ...
                      try { // safely instantiate component on selector elements with config, report errors and move on.
